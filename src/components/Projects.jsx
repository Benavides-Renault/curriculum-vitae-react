			...
			fr: {
				...
				projects: [
					...
					},
					{
						...
						description:
							'Système de gestion institutionnelle qui modernise les processus administratifs, y compris la gestion documentaire, les communications internes et le suivi des projets.',
						icon: Building,
						image: '/images/project-institutional.png',
						demoUrl: '#',
						downloadUrl: '#',
					},
					{
						...
						description:
							'Assistant de code intelligent qui aide les développeurs à écrire, déboguer et optimiser le code, avec prise en charge de plusieurs langages de programmation et frameworks.',
						icon: Code,
						image: '/images/project-store.png',
						demoUrl: '#',
						downloadUrl: '#',
					},
					{
						...
						description:
							"Outil éducatif qui visualise les réseaux neuronaux en temps réel, montrant comment ils apprennent et traitent l'information pendant l'entraînement.",
						icon: Brain,
						image: '/images/project-institutional.png',
						demoUrl: '#',
						downloadUrl: '#',
					...
					},
					{
						...
						description:
							'Système de gestion de base de données personnalisé avec constructeur visuel de requêtes, visualisation de données et sauvegardes automatisées.',
						icon: Database,
						image: '/images/project-store.png',
						demoUrl: '#',
						downloadUrl: '#',
					},
					{
						...
						description:
							'Boîte à outils complète en ligne de commande avec outils de productivité, gestion de fichiers et capacités de surveillance du système.',
						icon: Terminal,
						image: '/images/project-institutional.png',
						demoUrl: '#',
						downloadUrl: '#',
					...
					},
					{
						...
						description:
							"Plateforme d'analyse des médias sociaux avec métriques d'engagement, informations sur l'audience et suivi des performances du contenu.",
						icon: ShoppingBag,
						image: '/images/project-store.png',
						demoUrl: '#',
						downloadUrl: '#',
			...
			de: {
				...
				projects: [
					...
					},
					{
						...
						description:
							'Institutionelles Managementsystem, das Verwaltungsprozesse modernisiert, einschließlich Dokumentenmanagement, interne Kommunikation und Projektverfolgung.',
						icon: Building,
						image: '/images/project-institutional.png',
						demoUrl: '#',
						downloadUrl: '#',
					},
					{
						...
						description:
							'Intelligenter Code-Assistent, der Entwicklern beim Schreiben, Debuggen und Optimieren von Code hilft, mit Unterstützung für mehrere Programmiersprachen und Frameworks.',
						icon: Code,
						image: '/images/project-store.png',
						demoUrl: '#',
						downloadUrl: '#',
					},
					{
						...
						description:
							'Lernwerkzeug, das neuronale Netzwerke in Echtzeit visualisiert und zeigt, wie sie während des Trainings lernen und Informationen verarbeiten.',
						icon: Brain,
						image: '/images/project-institutional.png',
						demoUrl: '#',
						downloadUrl: '#',
					...
					},
					{
						...
						description:
							'Benutzerdefiniertes Datenbankverwaltungssystem mit visuellem Abfrage-Builder, Datenvisualisierung und automatisierten Backups.',
						icon: Database,
						image: '/images/project-store.png',
						demoUrl: '#',
						downloadUrl: '#',
					},
					{
						...
						description:
							'Umfassendes Kommandozeilen-Toolkit mit Produktivitätstools, Dateiverwaltung und Systemüberwachungsfunktionen.',
						icon: Terminal,
						image: '/images/project-institutional.png',
						demoUrl: '#',
						downloadUrl: '#',
					...
					},
					{
						...
						description:
							'Social-Media-Analyseplattform mit Engagement-Metriken, Informationen über die Zielgruppe und Verfolgung der Inhaltsleistung.',
						icon: ShoppingBag,
						image: '/images/project-store.png',
						demoUrl: '#',
						downloadUrl: '#',
	...
	return (
		<section id="projects" className="container mx-auto px-4 py-16 scroll-fade">
			...
			<div className="relative overflow-visible" ref={carouselRef}>
				<button
					onClick={handlePrev}
					className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-gray-100 dark:bg-white text-white dark:text-gray-900 p-2 rounded-full shadow-lg hover:opacity-90 transition-opacity -ml-4 md:ml-0"
				...
				<button
					onClick={handleNext}
					className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-gray-100 dark:bg-white text-white dark:text-gray-900 p-2 rounded-full shadow-lg hover:opacity-90 transition-opacity -mr-4 md:mr-0"
