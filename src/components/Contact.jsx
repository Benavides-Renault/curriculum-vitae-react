      ...
      <div className="max-w-2xl mx-auto glass-card p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <a 
            ...
            className="glass-card p-4 flex items-center justify-center gap-3 hover:bg-white/20 transition-colors text-black dark:text-white"
          >
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-gray-900 dark:bg-white text-white dark:text-black font-semibold py-3 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors"
          >
            {content.button}
          </button>
        </form>
