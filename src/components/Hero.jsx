	...
	const getContent = () => {
		const content = {
			...
			fr: {
				...
				description:
					"Scientifique et Programmeur passionné par la technologie et l'électronique industrielle. Je me spécialise dans le développement web et l'automatisation industrielle, combinant mes connaissances en programmation et en électronique pour créer des solutions innovantes.",
			...
			de: {
				...
				description:
					'Wissenschaftler und Programmierer mit Leidenschaft für Technologie und industrielle Elektronik. Ich spezialisiere mich auf Webentwicklung und industrielle Automatisierung und kombiniere mein Wissen in Programmierung und Elektronik, um innovative Lösungen zu schaffen.',
	...
	return (
		<section className="container mx-auto px-4 py-16">
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
				...
				<div
					className="glass-card p-4 smooth-fade flex items-center justify-center"
